...
import com.app.bookstoremanager.bean.ReadConfigBean;
...
import com.app.bookstoremanager.utils.UiUtils;
...
//                break;
            ...
            case ReadConfig.BG_NIGHT:
                canvas.drawColor(mContext.getResources().getColor(R.color.follow_read_white));
                fontColor = mContext.getResources().getColor(R.color.read_night);
                break;
        }
        mBgBitmap = bitmap;
    }
